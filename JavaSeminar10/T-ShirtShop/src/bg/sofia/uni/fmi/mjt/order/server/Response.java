...
public record Response(Status status, String additionalInfo, Collection<Order> orders) {
    ...
    public static Response create(int id) {
        String addInfo = "ORDER_ID=" + id;
        return new Response(Status.CREATED, addInfo, null);
    }
    ...
    public static Response notFound(int id) {
        String addInfo = "Order with id = " + id + " does not exist.";
        return new Response(Status.NOT_FOUND, addInfo, null);
    }
}